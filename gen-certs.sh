...
openssl req -new -key $SERVER_KEY_FILE -out $CSR_FILE -subj "/CN=trustytrojan.servehttp.com" -addext "subjectAltName=DNS:trustytrojan.servehttp.net"
...
sudo cp $SERVER_CERT_FILE /etc/ssl/certs/
sudo cp $SERVER_KEY_FILE /etc/ssl/private/
